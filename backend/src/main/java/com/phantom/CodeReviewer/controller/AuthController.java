...
public class AuthController {
    ...
    public ResponseEntity<?> handleGithubOAuthCallback(
        ...
        try {
            ...
            // 4. Return immediately for ultra-fast login (Repositories are fetched asynchronously on Repositories page)
            ...
            result.put("repositories", java.util.Collections.emptyList());
